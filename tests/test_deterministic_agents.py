...
class TestDeterministicRegionTagAgent:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ("# [START storage_control_get_project_intelligence_config]", "storage_control_get_project_intelligence_config", "python_single_tag"),
            ("// [START some_other_tag]\n// [END some_other_tag]", "some_other_tag", "js_single_tag"),
            ("/* [START one_tag] */\n...code...\n/* [START another_tag] */", "one_tag,another_tag", "multiple_tags_different_styles"),
            ("# [START vision_product_search_create_product]\n# [START vision_product_search_list_products]", "vision_product_search_create_product,vision_product_search_list_products", "python_multiple_tags"),
    ...
    async def test_region_tag_extraction(self, code, expected_tags_str, test_id):
        ...
        actual_tags = sorted(extracted_tags_str.split(',')) if extracted_tags_str else []
        expected_tags = sorted(expected_tags_str.split(',')) if expected_tags_str else []
